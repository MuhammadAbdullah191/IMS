...
# Product.create(name: "Product 101", stock: 40, description: "This is an eleventh product description.", price: 90, location_name: "Location 11", brand_id: 3, category_ids: categories.sample(rand(1..3)), supplier_ids: supplier.sample(rand(1..3)), created_at: Time.now, updated_at: Time.now)
